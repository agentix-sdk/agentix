...
export async function getNftTradingAccountInfo(
  ...
  if (nftReferralAccountInfo) {
    ...
    nftTradingAccountPk = (nftReferralAccountData as any).refererTradingAccount;
 ...
 */
export function createPerpClient(agent: Agentix<SolanaWalletBase>): PerpetualsClient {
  ...
  return new PerpetualsClient(
    ...
    (POOL_CONFIGS[0] as any).perpComposabilityProgramId,
...
export function get_flash_privilege(agent: Agentix<SolanaWalletBase>): Privilege {
