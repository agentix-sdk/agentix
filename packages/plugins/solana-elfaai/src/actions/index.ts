...
export const elfaPingAction: Action<SolanaWalletBase> = {
  ...
  schema: z.object({}),
  handler: async (agent: Agentix<SolanaWalletBase>) => {
...
export const elfaApiKeyStatusAction: Action<SolanaWalletBase> = {
...
export const elfaGetSmartMentionsAction: Action<SolanaWalletBase> = {
  ...
  handler: async (agent: Agentix<SolanaWalletBase>, input) => {
...
export const elfaGetTopMentionsByTickerAction: Action<SolanaWalletBase> = {
...
export const elfaSearchMentionsByKeywordsAction: Action<SolanaWalletBase> = {
...
export const elfaTrendingTokensAction: Action<SolanaWalletBase> = {
  ...
  schema: z.object({}),
  handler: async (agent: Agentix<SolanaWalletBase>, _input) => {
...
export const elfaSmartTwitterAccountStats: Action<SolanaWalletBase> = {
