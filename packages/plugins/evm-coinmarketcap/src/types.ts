...
export const CryptocurrencyListingsSchema = z.object({
...
export const CryptocurrencyQuotesLatestSchema = z.object({
...
export const ExchangeListingsSchema = z.object({
    start: z.number().optional().describe("Starting position of results"),
    limit: z.number().optional().describe("Number of results to return"),
    sort: z
...
export const ExchangeQuotesLatestSchema = z.object({
...
export const ContentLatestSchema = z.object({
    start: z.number().optional().describe("Starting position of results"),
    limit: z.number().optional().describe("Number of results to return"),
    id: z.array(z.string()).optional().describe("One or more cryptocurrency IDs"),
...
export const CryptocurrencyMapSchema = z.object({
...
export const CryptocurrencyOHLCVLatestSchema = z.object({
    id: z.array(z.string()).optional().describe("One or more cryptocurrency IDs"),
    symbol: z.array(z.string()).optional().describe("One or more cryptocurrency symbols"),
    convert: z.string().optional().describe("Currency to convert prices to"),
...
export const CryptocurrencyTrendingLatestSchema = z.object({
    start: z.number().optional().describe("Starting position of results"),
    limit: z.number().optional().describe("Number of results to return"),
...
export const CryptocurrencyTrendingMostVisitedSchema = z.object({
    start: z.number().optional().describe("Starting position of results"),
    limit: z.number().optional().describe("Number of results to return"),
    time_period: z.enum(["24h", "30d", "7d"]).optional().describe("Time period for trending data"),
    convert: z.string().optional().describe("Currency to convert prices to"),
...
export const CryptocurrencyTrendingGainersLosersSchema = z.object({
    start: z.number().optional().describe("Starting position of results"),
    limit: z.number().optional().describe("Number of results to return"),
...
// Export types
export type CryptocurrencyListingsParams = z.infer<typeof CryptocurrencyListingsSchema>;
export type CryptocurrencyQuotesLatestParams = z.infer<typeof CryptocurrencyQuotesLatestSchema>;
export type ExchangeListingsParams = z.infer<typeof ExchangeListingsSchema>;
export type ExchangeQuotesLatestParams = z.infer<typeof ExchangeQuotesLatestSchema>;
export type ContentLatestParams = z.infer<typeof ContentLatestSchema>;
export type CryptocurrencyMapParams = z.infer<typeof CryptocurrencyMapSchema>;
export type CryptocurrencyOHLCVLatestParams = z.infer<typeof CryptocurrencyOHLCVLatestSchema>;
export type CryptocurrencyTrendingLatestParams = z.infer<typeof CryptocurrencyTrendingLatestSchema>;
export type CryptocurrencyTrendingMostVisitedParams = z.infer<typeof CryptocurrencyTrendingMostVisitedSchema>;
export type CryptocurrencyTrendingGainersLosersParams = z.infer<typeof CryptocurrencyTrendingGainersLosersSchema>;
