...
const openPerpTradeLongAction: Action<SolanaWalletBase> = {
...
const openPerpTradeShortAction: Action<SolanaWalletBase> = {
...
const closePerpTradeLongAction: Action<SolanaWalletBase> = {
...
const closePerpTradeShortAction: Action<SolanaWalletBase> = {
